...
.PHONY: provision-$(1)-$(2)
provision-$(1)-$(2): .stamp-$(1)-download | setup-$(1)-$(2)
...
$(eval $(call LLVMProvisionTemplate,llvm,llvm32,32))
$(eval $(call LLVMProvisionTemplate,llvm,llvm64,64))
$(eval $(call LLVMProvisionTemplate,llvm36,llvm32,32))
...
.PHONY: provision-llvm-$(1)
provision-llvm-$(1): package-llvm-$(1)

.PHONY: provision
provision: provision-llvm-$(1)
endef

$(eval $(call LLVMMXEProvisionTemplate,llvmwin32,32))
$(eval $(call LLVMMXEProvisionTemplate,llvmwin64,64))
...
llvm36-llvm32_CMAKE_FLAGS=-DLLVM_BUILD_32_BITS=On
